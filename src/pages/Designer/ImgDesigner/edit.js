...
const EditImgDesign = () => {
    ...
    const imageUrl = imagesOld.length > 0 ? `https://techwiz5-inventory-service-ekb0h0d4c9gyfpby.eastasia-01.azurewebsites.net/api/v1/images_design/imagesDesign/${imagesOld[0]}` : '';
