...
import { getCategoryGallery, deleteCategoryGallery } from '~/services/Designer/categoryGallery';
...
function Category() {
    ...
    const handleDeleteConfirm = async () => {
        try {
            await deleteCategoryGallery(deleteId);
                    ...
                    <div className="col-md-12 grid-margin">
                        <div className="row">
                            <div className="col-12 col-xl-8 mb-4 mb-xl-0">
                                <h3 className="font-weight-bold">Categories Gallery</h3>
                                <Link to="/category-gallery/create" className="btn btn-primary">
                                                ...
                                                <tbody>
                                                    {searchedData.map((item, index) => (
                                                        <tr key={item.id}>
                                                            ...
                                                            <td>
                                                                <Link
                                                                    to={`/category-gallery/edit/${item.id}`}
