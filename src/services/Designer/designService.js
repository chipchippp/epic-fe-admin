...
export const getDesign = async (status) => {
    try {
        const response = await get(`/designer_profile/getByStatus?status=${status}`);
        return response;
    } catch (error) {
...
export const getTrashDesign = async (currentPage = 1, limit = 10) => {
    try {
        const response = await get(`/designer_profile/trash?page=${currentPage}&limit=${limit}`);
        return response;
    } catch (error) {
        console.error('Error fetching Design data:', error);
        throw error;
...
export const createDesign = async (data) => {
    try {
        const response = await post('/designer_profile', data);
        return response;
    } catch (error) {
...
export const editDesign = async (id) => {
    try {
        const response = await get(`/designer_profile/${id}`);
...
export const updateDesign = async (id, status) => { 
    try {
        const response = await put(`/designer_profile/updateStatus/${id}`, null, {
            params: { status },
        });
        return response;
    } catch (error) {
...
export const deleteDesign = async (id) => {
    try {
        await del(`/designer_profile/in-trash/${id}`);
        return true;
    } catch (error) {
